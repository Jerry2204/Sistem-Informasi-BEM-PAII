                                            ...
                                            @if (Auth::check())
                                                <form method="POST" action="{{ route('add_reply_forum', $forum->id) }}">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <textarea class="form-control font-14" name="answer"
                                                                ...
                                                                <div class="col-md-12 pl-0">
                                                                    ...
                                                                    <div class="collapse"
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            @else
                                                                                <p class="alert alert-danger text font-14">
                                                                                    Anda
                                                                                    harus login terlebih dahulu jika ingin
                    ...
                    <div class="text">
                        ...
                        <form method="POST" action="{{ route('add_reply_forum', $forum->id) }}">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control text font-14" name="answer" id="exampleFormControlTextarea1"
                                    rows="3"></textarea>
                            </div>

        ...
        <div class="pd-20 card-box">
            <div class="pd-20 table-responsive">
                <div class="clearfix mb-20">
                    <div class="pull-left">
                        <h4 class="text-blue h4">Tambah Pengeluaran</h4>
                    </div>
                </div>
                <form action="{{ route('pengeluaran.tambah') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row @error('jumlah') has-danger @enderror">
                        ...
                        <div class="col-sm-12 col-md-10">
                            <input class="form-control @error('jumlah') form-control-danger @enderror" type="number" id="jumlah" name="jumlah" value="{{ old('jumlah') }}" placeholder="ex: 200000">
                            @error('jumlah')
                    ...
                    <div class="form-group row @error('keperluan') has-danger @enderror">
                        ...
                        <div class="col-sm-12 col-md-10">
                            <input class="form-control @error('keperluan') form-control-danger @enderror" name="keperluan" id="keperluan" value="{{ old('keperluan') }}" placeholder="ex: Anggaran perlombaan" type="text">
                            @error('keperluan')
                            <div class="form-control-feedback">{{ $message }}</div>
                            @enderror
                        </div>

...
<head>
	...
	<link rel="stylesheet" type="text/css" href="{{ asset('assets/jquery-steps/jquery.steps.css') }}">
		...
		<div class="modal-dialog modal-dialog-centered max-width-400" role="document">
			<div class="modal-content">
				<div class="modal-body text-center font-18">
					...
					<div class="mb-30 text-center"><img src="{{ asset('assets/images/success.png') }}"></div>
